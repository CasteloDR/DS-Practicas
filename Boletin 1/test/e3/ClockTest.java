...
class ClockTest {
    ...
    void integerConstructors() {
        ...
        c = new Clock(6,36,12);
        assertEquals(6, c.getHours24());

        assertThrows(IllegalArgumentException.class, () -> new Clock(36, 25, 45));
        assertThrows(IllegalArgumentException.class, () -> new Clock(14, 32, 10, Clock.Period.AM));
    }
